...
export const part2Input = [
  {
    items: [71, 86],
    operation: (old) => Math.floor(old * 13),
    test: (value) => (value % 19 == 0 ? 6 : 7),
    inspections: 0,
  },
  {
    items: [66, 50, 90, 53, 88, 85],
    operation: (old) => Math.floor(old + 3),
    test: (value) => (value % 2 == 0 ? 5 : 4),
    inspections: 0,
  },
  {
    items: [97, 54, 89, 62, 84, 80, 63],
    operation: (old) => Math.floor(old + 6),
    test: (value) => (value % 13 == 0 ? 4 : 1),
    inspections: 0,
  },
  {
    items: [82, 97, 56, 92],
    operation: (old) => Math.floor(old + 2),
    test: (value) => (value % 5 == 0 ? 6 : 0),
    inspections: 0,
  },
  {
    items: [50, 99, 67, 61, 86],
    operation: (old) => Math.floor(old * old),
    test: (value) => (value % 7 == 0 ? 5 : 3),
    inspections: 0,
  },
  {
    items: [61, 66, 72, 55, 64, 53, 72, 63],
    operation: (old) => Math.floor(old + 4),
    test: (value) => (value % 11 == 0 ? 3 : 0),
    inspections: 0,
  },
  {
    items: [59, 79, 63],
    operation: (old) => Math.floor(old * 7),
    test: (value) => (value % 17 == 0 ? 2 : 7),
    inspections: 0,
  },
  {
